...
# 全局变量
dataset_path = 'C:/Users/whg/Downloads/fall/dataset'
output_model_path = 'models/miniGoogle_20.hdf5'
output_plot_path = 'plots/miniGoogle_20.png'
...
model = MiniGOOGLENet.build(width=TARGET_WIDTH, height=TARGET_HEIGHT,
                            depth=3, classes=2)
